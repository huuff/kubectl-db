...
kubectl ${namespace:+-n $namespace} run "$db_resource-cli" --rm -i --image governmentpaas/psql -- psql "postgresql://$user:$password@$db_resource.${namespace:+$namespace.}svc:5432/$database"
